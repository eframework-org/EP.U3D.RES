...
public class TestXAssetCore
{
    ...
    public IEnumerator Handler()
    {
        ...
        // 测试IsDone
        handler = XAsset.Resource.LoadAsync("Packages/EP.U3D.RES/Tests/Runtime/Resources/Bundle/Prefab/TestCube", typeof(GameObject));
        ...
        yield return XAsset.Resource.LoadAsync("Packages/EP.U3D.RES/Tests/Runtime/Resources/Bundle/Prefab/TestCube", typeof(GameObject), null, handler);
