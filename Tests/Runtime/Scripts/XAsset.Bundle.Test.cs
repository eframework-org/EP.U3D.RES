...
public class TestXAssetBundle
{
    ...
    public void Release()
    {
        ...
        string bundleName = "packages_ep.u3d.res_tests_runtime_resources_bundle_prefab_testcube.bundle";
    ...
    {
        // Act
        var bundleName = "packages_ep.u3d.res_tests_runtime_resources_bundle_prefab_testcube.bundle";
        // 检查初始状态
